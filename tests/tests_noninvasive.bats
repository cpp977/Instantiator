...
@test "Run Instantiator to generate template instantantions in noninvasive mode." {
...
@test "Run Instantiator to remove template instantantions in noninvasive mode." {
